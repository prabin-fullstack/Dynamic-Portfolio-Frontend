...
const contactLinks = [
  { label: 'prabinsonu42@gmail.com', href: 'mailto:prabinsonu42@gmail' },
...
function FooterCol({ title, links }) {
  ...
  return (
    <div className={`footer-col ${open ? 'open' : ''}`}>
      <button className="footer-col-toggle" onClick={() => setOpen((p) => !p)}>
...
function Footer({project}) {
  ...
  const projectLinks = [
    ...project.slice(0, 3).map((item) => ({
      label: item.title,
      href: item.live_link || item.github_link || '#'
    })),
    { label: 'View all →', href: '#project' }
  ]
      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            <p className="footer-brand-name">PRA<span>BIN</span></p>
            <p className="footer-brand-desc">
              Full-stack developer crafting clean, performant web experiences.
              Open to freelance projects and full-time roles.
            </p>
            <div className="footer-social">
              <a href="https://github.com/prabin-fullstack" target="_blank" rel="noreferrer"
              ...
              <a href="https://www.linkedin.com/in/prabin-o-fullstack/" target="_blank" rel="noreferrer"
          ...
          <FooterCol title="Projects" links={projectLinks} />
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            © {year} <span>PRABIN</span>. Built with React &amp; Django REST Framework.
          </p>
          <div className="footer-badge">Open to work</div>
        </div>
